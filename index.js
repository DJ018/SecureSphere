...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileNavLinks = mobileNavMenu.querySelectorAll('.nav-links a');
    ...
    const mobileCTABtn = mobileNavMenu.querySelector('.cta-btn');
    if (mobileCTABtn) {
        mobileCTABtn.addEventListener('click', toggleMobileMenu);
    }
    ...
    // Close menu on window resize if open (prevents issues when switching between mobile/desktop)
    let resizeTimer;
